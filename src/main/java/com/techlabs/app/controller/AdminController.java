...
public class AdminController {
	...
	public ResponseEntity<PagedResponse<TransactionResponse>> getTransactionsOfAccount(
	    ...
	    PagedResponse<TransactionResponse> pagedResponse = service.getTransactionsOfAccount(account_id, page, size, sortBy, direction);
	...
	public ResponseEntity<TransactionResponse> getTransactionById(@PathVariable int transaction_id) {
